...
from ansible_collections.sense.aristaeos.plugins.module_utils.network.aristaeos import get_config
...
from ansible_collections.sense.aristaeos.plugins.module_utils.network.aristaeos import load_config, run_commands
